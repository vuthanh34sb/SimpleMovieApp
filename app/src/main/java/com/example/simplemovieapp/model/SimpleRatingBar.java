...
public class SimpleRatingBar extends View {
  ...
  private void parseAttrs(AttributeSet attrs) {
    TypedArray arr = getContext().obtainStyledAttributes(attrs, com.example.simplemovieapp.R.styleable.SimpleRatingBar);

    borderColor = arr.getColor(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_borderColor, getResources().getColor(com.example.simplemovieapp.R.color.golden_stars));
    fillColor = arr.getColor(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_fillColor, borderColor);
    starBackgroundColor = arr.getColor(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_starBackgroundColor, Color.TRANSPARENT);
    backgroundColor = arr.getColor(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_backgroundColor, Color.TRANSPARENT);

    pressedBorderColor = arr.getColor(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_pressedBorderColor, borderColor);
    pressedFillColor = arr.getColor(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_pressedFillColor, fillColor);
    pressedStarBackgroundColor = arr.getColor(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_pressedStarBackgroundColor, starBackgroundColor);
    pressedBackgroundColor = arr.getColor(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_pressedBackgroundColor, backgroundColor);

    numberOfStars = arr.getInteger(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_numberOfStars, 5);

    starsSeparation = arr.getDimensionPixelSize(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_starsSeparation, (int)valueToPixels(4, Dimension.DP));
    maxStarSize = arr.getDimensionPixelSize(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_maxStarSize, Integer.MAX_VALUE);
    desiredStarSize = arr.getDimensionPixelSize(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_starSize, Integer.MAX_VALUE);
    stepSize = arr.getFloat(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_stepSize, 0.1f);
    starBorderWidth = arr.getFloat(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_starBorderWidth, 5f);
    starCornerRadius = arr.getFloat(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_starCornerRadius, 6f);

    rating = normalizeRating(arr.getFloat(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_rating, 0f));
    isIndicator = arr.getBoolean(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_isIndicator, false);
    drawBorderEnabled = arr.getBoolean(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_drawBorderEnabled, true);
    gravity = Gravity.fromId(arr.getInt(com.example.simplemovieapp.R.styleable.SimpleRatingBar_srb_gravity, Gravity.Left.id));
